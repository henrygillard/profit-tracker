...
/**
 * upsertOrder(prisma, shop, parsedOrder, shopifyPaymentsFee, shopPlan, existingFeeSource)
 ...
 * @param {string|null} [existingFeeSource=null] - Preserved feeSource from refund handler (keeps 'verified' status)
